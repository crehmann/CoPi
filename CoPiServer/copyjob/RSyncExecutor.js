...
const execute = (copyJobOptions) => {
    ...
    const execution = new CopyJobExecution(
        rsync.execute((error, code, cmd) => {
            ...
            socketService.emit("copyJobProgress", { id: id, progress: execution.progress, state: execution.state });
        }, (data) => {
            ...
            for (let i = 0; i < lines.length; i++) {
                ...
                if (matches && matches.length >= 2) {
                    ...
                    socketService.emit("copyJobProgress", { id: id, progress: execution.progress });
                } else {
